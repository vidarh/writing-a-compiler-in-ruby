# Resolved investigations (archived from KNOWN_ISSUES.md 2026-07-04)

Full investigation logs for fixed bugs, preserved for their technique value.
Numbering matches the original KNOWN_ISSUES entries.
