...
#  },
  ...
  "break" => Oper.new(6, :break, :prefix, 1, 0, :right, 3),
  "next"  => Oper.new(6, :next,  :prefix, 1, 0, :right, 3),
  "defined?" => Oper.new(6, :defined?, :prefix, nil, nil, :right, 6),  # pri=6 to avoid premature = reduction (=has right_pri=5)
